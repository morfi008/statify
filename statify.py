...
"""
To run, create object: client = SpotifyAPI(client_id, client_secret)
# Test basic query
# client._search_("Time", search_type="track")
...
class SpotifyAPI(object):
    ...
    def _search_(self, query, search_type='artist'):
        headers = self.get_resource_header()
...
class potty_mouth_meter(object):
    artist_id = None
    artist_pmm_score = None

class mom_i_made_it_meter(object):
    artist_id = None
    artist_mimim_score = None
    # popularity rating
    # followers count
